...
const Cart = () => {
  ...
  const handleRemoveFromCart = async (productId) => {
    try {
      ...
      const response = await axios.delete('https://api.baazaarplus.xyz/carts/cart/product/remove', {
        headers: { Authorization: `Bearer ${token}` },
  ...
  const handleIncreaseQuantity = async (productId) => {
    try {
      ...
      const response = await axios.put('https://api.baazaarplus.xyz/carts/cart/product/increase', {
        userId,
        productId
      }, {
        headers: { Authorization: `Bearer ${token}` }
  ...
  const handleDecreaseQuantity = async (productId) => {
    try {
      ...
      const response = await axios.put('https://api.baazaarplus.xyz/carts/cart/product/decrease', {
        userId,
        productId
      }, {
        headers: { Authorization: `Bearer ${token}` }
  ...
  const handleClearCart = async () => {
    try {
      ...
      const response = await axios.delete(`https://api.baazaarplus.xyz/carts/cart/clear/${userId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
